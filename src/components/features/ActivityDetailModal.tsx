      ...
      {activity && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/70 z-[55] lg:left-[72px] lg:w-[40%] lg:right-auto"
            onClick={onClose}
          />
          ...
          <motion.div
            ...
            className="fixed z-[60] overflow-hidden flex flex-col bottom-0 left-0 right-0 max-h-[85dvh] rounded-t-3xl lg:inset-0 lg:left-[72px] lg:w-[40%] lg:right-auto lg:bottom-0 lg:max-h-full lg:rounded-none"
            style={{
