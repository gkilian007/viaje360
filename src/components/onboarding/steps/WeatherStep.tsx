      ...
      <div className="flex flex-col gap-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-[#e4e2e4]">Sí, adapta mi plan</span>
                <span className="text-[10px] bg-[#30D158]/20 text-[#30D158] px-2 py-0.5 rounded-full font-medium">Recomendado</span>
              </div>
              <p className="text-sm text-[#c0c6d6] mt-1">Si cambia el tiempo, reorganizamos actividades al aire libre</p>
            </div>
          </div>
        </motion.button>
        ...
        >
          <div className="flex items-center gap-3">
            <span className="text-3xl">📌</span>
            <div>
              <div className="font-semibold text-[#e4e2e4]">No, mantén el plan original</div>
              <p className="text-sm text-[#c0c6d6] mt-0.5">Sin cambios aunque llueva</p>
            </div>
          </div>
        </motion.button>
      </div>
