...
export const Component = () => {
  ...
  useEffect(() => {
    ...
    // Video pan animation (CSS-driven, independent of scroll)
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Vignette */}
      <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 80% 70% at 50% 50%, transparent 20%, rgba(0,0,0,0.55) 100%)' }} />
      ...
      <div className="absolute inset-0 flex items-center justify-end pr-[8vw] pointer-events-none z-10 hidden md:flex">
        <div ref={phoneRef} className="relative opacity-0" style={{ width: 'clamp(200px, 22vw, 320px)', aspectRatio: '9/19.5', borderRadius: '2.5rem', overflow: 'hidden', border: '3px solid rgba(255,255,255,0.08)', boxShadow: '0 40px 100px rgba(10,132,255,0.2), 0 0 60px rgba(0,0,0,0.5)', background: '#000' }}>
          <video
            ref={phoneVideoRef}
            muted
            autoPlay
