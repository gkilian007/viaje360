...
export const onboardingRequestSchema = z.object({
  ...
  arrivalTime: arrivalTimeSchema.nullable().optional().default(null),
  departureTime: arrivalTimeSchema.nullable().optional().default(null),
  companion: companionSchema.nullable().optional().default(null),
  groupSize: z.number().int().min(1).max(20).optional().default(1),
  kidsPets: z.array(kidsPetsSchema).optional().default([]),
  ...
  pace: z.number().min(0).max(100).optional().default(50),
  wantsRestDays: z.boolean().optional().default(false),
  restDayFrequency: restDayFrequencySchema.nullable().optional().default(null),
  wakeTime: z.number().min(0).max(100).optional().default(50),
  wantsSiesta: z.boolean().optional().default(false),
  budget: budgetSchema.nullable().optional().default(null),
  splurge: z.array(splurgeSchema).optional().default([]),
  dietary: z.array(dietarySchema).optional().default([]),
  allergies: z.string().optional().default(""),
  transport: z.array(transportSchema).optional().default([]),
  weatherAdaptation: z.boolean().optional().default(true),
  firstTime: z.boolean().nullable().optional().default(null),
