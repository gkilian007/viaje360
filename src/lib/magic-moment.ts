...
const POI_DATABASE: Record<string, CuratedPOI[]> = {
  barcelona: [
    ...
    { name: "Bunkers del Carmel", type: "fotografia", lat: 41.4194, lng: 2.1617, durationMinutes: 45, description: "Antiguas baterías antiaéreas con la mejor panorámica de Barcelona", emoji: "🌆", openFrom: 0, openUntil: 24 },
    { name: "Bar Calders", type: "nocturna", lat: 41.3765, lng: 2.1624, durationMinutes: 20, description: "Bar de vermut con terrazas en el barrio del Poble Sec. Ambiente local", emoji: "🍷", openFrom: 10, openUntil: 24 },
  ...
  madrid: [
    ...
    { name: "Taberna Antonio Sánchez", type: "gastronomia", lat: 40.4111, lng: -3.7049, durationMinutes: 25, description: "La taberna más antigua de Madrid (1830). Ambiente taurino y cocido madrileño", emoji: "🍷", openFrom: 12, openUntil: 23 },
    ...
    { name: "Café Comercial", type: "cultural", lat: 40.4287, lng: -3.702, durationMinutes: 20, description: "El café más antiguo de Madrid (1887) en Bilbao. Tertulia y prensa", emoji: "☕", openFrom: 8, openUntil: 24 },
  ],
  paris: [
    { name: "Marché d'Aligre", type: "gastronomia", lat: 48.8489, lng: 2.378, durationMinutes: 30, description: "El mercado más auténtico de París. Menos turístico que Bastille. Precio local", emoji: "🥐", openFrom: 7, openUntil: 13 },
    { name: "Promenade Plantée", type: "naturaleza", lat: 48.849, lng: 2.3724, durationMinutes: 30, description: "Jardín elevado sobre una línea de tren abandonada. El High Line parisino", emoji: "🌿", openFrom: 8, openUntil: 21 },
    ...
    { name: "Rue Crémieux", type: "fotografia", lat: 48.8469, lng: 2.3709, durationMinutes: 15, description: "La calle más colorida de París. Cada casa pintada de un color diferente", emoji: "🎨", openFrom: 0, openUntil: 24 },
  ],
  rome: [
    ...
    { name: "Trastevere", type: "cultural", lat: 41.8912, lng: 12.4668, durationMinutes: 30, description: "El barrio más auténtico de Roma. Callecitas medievales y trattorie locales", emoji: "🏡", openFrom: 0, openUntil: 24 },
  ...
  tokyo: [
    { name: "Yanaka Ginza", type: "cultural", lat: 35.7277, lng: 139.7653, durationMinutes: 30, description: "Calle comercial del Tokio de los 50s. Tiendas locales y gatos callejeros", emoji: "🐱", openFrom: 10, openUntil: 19 },
  ...
  amsterdam: [
    ...
    { name: "Albert Cuypmarkt", type: "gastronomia", lat: 52.3552, lng: 4.8918, durationMinutes: 30, description: "El mercado más grande de Holanda. Herring fresquísimo y stroopwafels", emoji: "🐟", openFrom: 9, openUntil: 17 },
  ],
  ...
  berlin: [
    ...
    { name: "Café Einstein Stammhaus", type: "gastronomia", lat: 52.502, lng: 13.3547, durationMinutes: 25, description: "Histórico café vienés en una villa de 1878. El mejor Wiener Schnitzel y strudel de Berlín", emoji: "☕", openFrom: 9, openUntil: 23 },
    ...
    { name: "Bergmannstraße", type: "gastronomia", lat: 52.4889, lng: 13.3983, durationMinutes: 30, description: "La calle más bohemia de Kreuzberg: delicatessen, cafés hipster y anticuarios", emoji: "🌿", openFrom: 9, openUntil: 22 },
  ...
  lisbon: [
    { name: "LX Factory", type: "cultural", lat: 38.7026, lng: -9.1787, durationMinutes: 45, description: "Complejo industrial rehabilitado con restaurantes, librerías y mercado dominical. El barrio creativo de Lisboa", emoji: "🏭", openFrom: 10, openUntil: 24 },
    ...
    { name: "Feira da Ladra", type: "shopping", lat: 38.7154, lng: -9.1259, durationMinutes: 40, description: "Mercado de pulgas al aire libre en el Campo de Santa Clara. Martes y sábados", emoji: "🪙", openFrom: 9, openUntil: 18 },
    { name: "Tasca do Chico", type: "gastronomia", lat: 38.7125, lng: -9.1266, durationMinutes: 30, description: "Tasca pequeñísima en Alfama con fado en vivo. Reserva imprescindible pero intenta colarte", emoji: "🎶", openFrom: 20, openUntil: 24 },
  ...
  seoul: [
    ...
    { name: "Noryangjin Fish Market", type: "gastronomia", lat: 37.5135, lng: 126.9382, durationMinutes: 40, description: "Mercado de pescado abierto 24h. Elige tu marisco vivo y se lo cocinan en el restaurante de encima", emoji: "🦞", openFrom: 0, openUntil: 24 },
  ...
  dubai: [
    { name: "Al Fahidi Historical Neighbourhood", type: "historia", lat: 25.2642, lng: 55.3002, durationMinutes: 40, description: "Barrio más antiguo de Dubái con torres de viento y museos locales. Refrescante contraste al skyline", emoji: "🏺", openFrom: 8, openUntil: 20 },
    { name: "Spice Souk", type: "gastronomia", lat: 25.2676, lng: 55.2971, durationMinutes: 25, description: "Zoco de especias junto al Creek. Azafrán iraní, pimienta rosa y cardamomo a granel", emoji: "🌶️", openFrom: 9, openUntil: 22 },
    ...
    { name: "Alserkal Avenue", type: "arte", lat: 25.1412, lng: 55.2257, durationMinutes: 35, description: "Complejo de arte contemporáneo en Al Quoz. Galerías internacionales en naves industriales", emoji: "🖼️", openFrom: 10, openUntil: 19 },
  ],

  "mexico city": [
    { name: "Barrio de Coyoacán", type: "cultural", lat: 19.3156, lng: -99.133, durationMinutes: 60, description: "Barrio colonial bohemio, casa de Frida Kahlo y León Trotsky. Mercado artesanal y cantinas centenarias", emoji: "🎨", openFrom: 8, openUntil: 22 },
    { name: "Mercado Jamaica", type: "gastronomia", lat: 19.4077, lng: -99.1231, durationMinutes: 30, description: "El mayor mercado de flores y plantas de México. Colores desbordantes y precios locales", emoji: "💐", openFrom: 5, openUntil: 19 },
    { name: "Xochimilco", type: "naturaleza", lat: 19.2634, lng: -99.1047, durationMinutes: 90, description: "Canales aztecas con trajineras de colores. Cerveza fría, marimba en vivo y flor de Jamaica", emoji: "🛶", openFrom: 9, openUntil: 18 },
    { name: "Mercado de Medellín", type: "gastronomia", lat: 19.4104, lng: -99.1633, durationMinutes: 30, description: "Mercado barrial de la Colonia Roma. Jugos tropicales, mariscos y el mejor chile en nogada de temporada", emoji: "🌮", openFrom: 7, openUntil: 20 },
    { name: "Librería El Péndulo", type: "cultural", lat: 19.3045, lng: -99.1906, durationMinutes: 25, description: "Librería-café con jardín interior en la Condesa. Café de olla y libros en español e inglés", emoji: "📚", openFrom: 8, openUntil: 22 },
  ],

  "buenos aires": [
    { name: "Mercado de San Telmo", type: "gastronomia", lat: -34.619, lng: -58.3725, durationMinutes: 40, description: "Mercado cubierto de 1897 con antigüedades, café, empanadas y tango. El más auténtico de BA", emoji: "🥩", openFrom: 10, openUntil: 20 },
    ...
    { name: "Feria de Mataderos", type: "cultural", lat: -34.6625, lng: -58.5, durationMinutes: 60, description: "Feria artesanal gaucha solo domingos. Jinetes, folk argentino y locro al mediodía", emoji: "🤠", openFrom: 11, openUntil: 20 },
