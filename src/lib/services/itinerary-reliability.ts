...
function normalizeActivity(
  ...
  const activity: GeneratedActivity = {
    ...
    description: normalizeWhitespace(raw.description) || undefined,
    ...
    pricePerPerson: typeof raw.pricePerPerson === "number" && raw.pricePerPerson > 0 ? raw.pricePerPerson : undefined,
    imageQuery: normalizeWhitespace(raw.imageQuery) || `${name} ${context.destination}`,
